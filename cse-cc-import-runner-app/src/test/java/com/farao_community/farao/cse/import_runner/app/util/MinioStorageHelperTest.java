...
class MinioStorageHelperTest {
    ...
    void makeArtifactsMinioDestinationAdaptedPathTest() {
        assertEquals("CSE/IMPORT-ADAPTED/D2CC/2022/01/28/11_30/ARTIFACTS/", MinioStorageHelper.makeDestinationMinioPath(OffsetDateTime.parse("2022-01-28T10:30Z"), ProcessType.D2CC, MinioStorageHelper.FileKind.ARTIFACTS, ZoneId.of("Europe/Paris"), true));
    }

    @Test
    void makeOutputsMinioDestinationAdaptedPathTest() {
        assertEquals("CSE/IMPORT-ADAPTED/IDCC/2022/01/28/16_30/OUTPUTS/", MinioStorageHelper.makeDestinationMinioPath(OffsetDateTime.parse("2022-01-28T15:30Z"), ProcessType.IDCC, MinioStorageHelper.FileKind.OUTPUTS, ZoneId.of("Europe/Paris"), true));
    }

    @Test
    void makeAConfigurationsMinioDestinationAdaptedPathTest() {
        assertEquals("CSE/IMPORT-ADAPTED/D2CC/2022/01/28/20_30/ARTIFACTS/", MinioStorageHelper.makeDestinationMinioPath(OffsetDateTime.parse("2022-01-28T19:30Z"), ProcessType.D2CC, MinioStorageHelper.FileKind.ARTIFACTS, ZoneId.of("Europe/Paris"), true));
    }
}
