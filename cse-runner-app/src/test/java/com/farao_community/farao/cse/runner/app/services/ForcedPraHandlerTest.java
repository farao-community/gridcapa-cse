...
class ForcedPraHandlerTest {
    ...
    void checkCracAndForcedPrasAreConsistent() {
        ...
        assertDoesNotThrow(() -> forcedPrasHandler.checkInputForcesPrasConsistencyWithCrac(forcedPrasIds, crac));
    }
    ...
    void checkCracAndForcedPrasAreNotConsistent() {
        ...
        assertThrows(CseDataException.class, () -> forcedPrasHandler.checkInputForcesPrasConsistencyWithCrac(forcedPrasIds, crac));
    }
